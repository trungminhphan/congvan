...
<div class="grid">
	<div class="row cells12">
		...
		<div class="cell colspan6 input-control text" >
			...
			<input type="text" name="username" id="username" value="<?php echo isset($username) ? $username : ''; ?>" placeholder="Nhập tài khoản" class="edit-text" <?php echo $id ? 'readonly' : ''; ?>  data-validate-func="minlength" data-validate-arg="5" data-validate-hint="Ít nhất 5 ký tự!"/>
	...
	<div class="row cells12">
		...
		<div class="cell colspan6 input-control text" >
			<input type="password" name="password" id="password" value="" placeholder="Nhập mật khẩu" class="edit-text" data-validate-func="minlength" data-validate-arg="6" data-validate-hint="Ít nhất 6 ký tự!" />
			<span class="input-state-error mif-warning"></span><span class="input-state-success mif-checkmark"></span>
		</div>
		<div class="cell colspan4"></div>
	</div>

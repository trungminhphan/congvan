...
PDFJS.locale = 'vi-VN';//PDFJS.locale === undefined ? navigator.language : PDFJS.locale;
...
function getPDFFileNameFromURL(url, defaultFilename) {
 if (typeof defaultFilename === 'undefined') {
  defaultFilename = 'uploads/document.pdf';
 }
 var reURI = /^(?:(?:[^:]+:)?\/\/[^\/]+)?([^?#]*)(\?[^#]*)?(#.*)?$/;
...
var PDFViewerApplication = {
 ...
 download: function pdfViewDownload() {
  ...
  var filename = document.getElementById("afilename").value;//getPDFFileNameFromURL(this.url);
...
var SecondaryToolbar = function SecondaryToolbarClosure() {
 function SecondaryToolbar(options, mainContainer, eventBus) {
  ...
  this.buttons = [
   ...
   {
    element: options.secondarydocumentPropertiesButton,
    eventName: 'documentproperties',
    close: true
   }
  ];
...
function getViewerConfiguration() {
 return {
  ...
  secondaryToolbar: {
   ...
   secondarydocumentPropertiesButton: document.getElementById('secondarydocumentProperties'),
